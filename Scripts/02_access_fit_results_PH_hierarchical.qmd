...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_PH_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = c("ID","aud_group","reinforcer_type","block","p_corr","alpha","invtemp","gamma"))
}
```
