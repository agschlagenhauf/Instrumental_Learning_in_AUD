...
fit_file <- 'fit_n_71_2024-01-09_bandit2arm_delta_PH_withC_rep_hierarchical_estimation0_delta0.9_stepsize0.5.rds'
...
if (estimation==1) {
  write.table(params, file=file.path(out_path, 'Params_PH_withC_rep_hierarchical.txt'), append = FALSE, sep = " ", dec = ".", row.names = F, col.names = c("ID","aud_group","reinforcer_type","block","p_corr","alpha","invtemp","gamma","C_const","pi"))
}
```
